...
<head>
    ...
    <title>后台管理主页</title>
    <link rel="stylesheet" type="text/css" href="<%=basePath%>/resources/admin/eazyui/easyui/1.3.4/themes/default/easyui.css" />
    <link rel="stylesheet" type="text/css" href="<%=basePath%>/resources/admin/eazyui/css/wu.css" />
    <link rel="stylesheet" type="text/css" href="<%=basePath%>/resources/admin/eazyui/css/icon.css" />
    <script type="text/javascript" src="<%=basePath%>/resources/admin/eazyui/js/jquery-1.8.0.min.js"></script>
    <script type="text/javascript" src="<%=basePath%>/resources/admin/eazyui/easyui/1.3.4/jquery.easyui.min.js"></script>
    <script type="text/javascript" src="<%=basePath%>/resources/admin/eazyui/easyui/1.3.4/locale/easyui-lang-zh_CN.js"></script>
    <script>
        var pc;
        //不要放在$(function(){});中
...
<div id="loading" style="position:absolute;z-index:1000;top:0px;left:0px;width:100%;height:100%;background:#FFFFFF;text-align :center;padding-top:6%;">
    <img src="<%=basePath%>/resources/admin/eazyui/images/loading.jpg" width="50%">
</div>
<div class="wu-header" data-options="region:'north',border:false,split:true">
    <div class="wu-header-left">
        <h1>【bonsoirzw】后台管理系统</h1>
    </div>
...
<div class="wu-footer" data-options="region:'south',border:true,split:true">
    &copy; 2019 bonsoirzw All Rights Reserved
</div>
<!-- end of footer -->
